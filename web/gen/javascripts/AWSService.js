...
(function() {
  ...
  AWSService = (function() {
    function AWSService($log, $http, $q, $cookieStore, $window) {
      ...
      this.venuesDb["2"] = '{ "name":"We Work", "about":"Located near the Jingan Temple, the WeWork Yanping Lu coworking space has a rich culture and history. It also offers easy access to two main Metro stops, Line 2 and Line 7, and is surrounded by restaurants offering traditional Shanghai cuisine. Members can enjoy a giant fish tank wall, large meeting rooms, and office space flooded with sunlight thanks to the floor-to-ceiling windows.", "address":"1355 Market Street, Suite 900, San Francisco, CA 94103", "type":"co-working space", "contact":{ "name":"Tomasz", "phone":"1234567", "wechat":"kozlowst", "skype":"kozlow111" }, "venue":{ "capacity":"400", "confRooms":"20", "desks":"300", "offices":"30" }, "amenities":{ "wifi":"yes", "coffee":"yes", "printer":"yes", "onsiteSupport":"yes", "showers":"no" }, "directions":{ "info":"Located near the Jingan Temple, the WeWork Yanping Lu coworking space has a rich culture and history. It also offers easy access to two main Metro stops, Line 2 and Line 7", "bus":"Line 230, Liu Chan Road", "metro":"Line 2, station Liu Chan, Exit A1", "coordinates":{ "longitude":"38.913184", "latitude":"-77.036982" } }, "offer":[ { "type":"Conference Room", "capacity":"16", "amenities":{ "projector":"yes", "whiteboard":"no", "smartboard":"yes", "camera":"yes" }, "pricing":[ { "price":"200CNY", "unit":"per hour", "comment":"minimum booking 1 hour" }, { "price":"500CNY", "unit":"per day" } ] }, { "type":"Desk", "capacity":"1", "amenities":{ "whiteboard":"yes", "deskLamp":"yes" }, "pricing":[ { "price":"200CNY", "unit":"per day", "comment":"minimum booking 1 day" }, { "price":"1100CNY", "unit":"per month" } ] } ] }';
    }
